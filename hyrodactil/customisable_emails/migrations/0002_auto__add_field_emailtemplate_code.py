...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailTemplate.code'
        db.add_column(u'customisable_emails_emailtemplate', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailTemplate.code'
        db.delete_column(u'customisable_emails_emailtemplate', 'code')
