...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.rating'
        db.delete_column(u'applications_application', 'rating')


    def backwards(self, orm):
        # Adding field 'Application.rating'
        db.add_column(u'applications_application', 'rating',
