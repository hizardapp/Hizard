...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplicationAnswer.question'
        db.add_column(u'applications_applicationanswer', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['openings.OpeningQuestion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplicationAnswer.question'
        db.delete_column(u'applications_applicationanswer', 'question_id')
