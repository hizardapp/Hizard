...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplicationMessage.parent'
        db.add_column(u'applications_applicationmessage', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applications.ApplicationMessage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplicationMessage.parent'
        db.delete_column(u'applications_applicationmessage', 'parent_id')
