...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationTransition'
        db.create_table(u'applications_applicationtransition', (
        ...
        db.send_create_signal(u'applications', ['ApplicationTransition'])

        # Deleting field 'Application.stage'
        db.delete_column(u'applications_application', 'stage_id')


    def backwards(self, orm):
        # Deleting model 'ApplicationTransition'
        db.delete_table(u'applications_applicationtransition')

        # Adding field 'Application.stage'
        db.add_column(u'applications_application', 'stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companysettings.InterviewStage'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'applications.applicationtransition': {
            'Meta': {'ordering': "('created',)", 'object_name': 'ApplicationTransition'},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['applications.Application']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
