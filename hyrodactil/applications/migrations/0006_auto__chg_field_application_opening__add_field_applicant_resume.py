...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.opening'
        db.alter_column(u'applications_application', 'opening_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openings.Opening']))
        # Adding field 'Applicant.resume'
        db.add_column(u'applications_applicant', 'resume',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=770),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Application.opening'
        db.alter_column(u'applications_application', 'opening_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.Opening']))
        # Deleting field 'Applicant.resume'
        db.delete_column(u'applications_applicant', 'resume')
    ...
    models = {
        ...
        u'applications.applicant': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'resume': ('django.db.models.fields.CharField', [], {'max_length': '770'})
        },
