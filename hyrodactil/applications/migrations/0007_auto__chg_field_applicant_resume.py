...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'applications_applicant', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Applicant.resume'
        db.alter_column(u'applications_applicant', 'resume', self.gf('django.db.models.fields.CharField')(max_length=770))
