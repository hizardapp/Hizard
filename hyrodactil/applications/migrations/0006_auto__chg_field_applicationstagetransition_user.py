...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApplicationStageTransition.user'
        db.alter_column(u'applications_applicationstagetransition', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ApplicationStageTransition.user'
        raise RuntimeError("Cannot reverse this migration. 'ApplicationStageTransition.user' and its values cannot be restored.")
