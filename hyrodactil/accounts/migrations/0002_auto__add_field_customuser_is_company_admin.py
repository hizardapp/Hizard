...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.is_company_admin'
        db.add_column(u'accounts_customuser', 'is_company_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.is_company_admin'
        db.delete_column(u'accounts_customuser', 'is_company_admin')
