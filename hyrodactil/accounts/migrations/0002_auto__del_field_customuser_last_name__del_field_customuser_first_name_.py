...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'accounts_customuser', 'last_name')

        # Deleting field 'CustomUser.first_name'
        db.delete_column(u'accounts_customuser', 'first_name')

        # Adding field 'CustomUser.name'
        db.add_column(u'accounts_customuser', 'name',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'accounts_customuser', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.first_name'
        db.add_column(u'accounts_customuser', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'CustomUser.name'
        db.delete_column(u'accounts_customuser', 'name')
