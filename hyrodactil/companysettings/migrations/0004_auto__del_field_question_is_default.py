...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.is_default'
        db.delete_column(u'companysettings_question', 'is_default')


    def backwards(self, orm):
        # Adding field 'Question.is_default'
        db.add_column(u'companysettings_question', 'is_default',
