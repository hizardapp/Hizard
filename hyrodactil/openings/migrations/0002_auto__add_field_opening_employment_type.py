...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opening.employment_type'
        db.add_column(u'openings_opening', 'employment_type',
                      self.gf('django.db.models.fields.CharField')(default='full_time', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opening.employment_type'
        db.delete_column(u'openings_opening', 'employment_type')
